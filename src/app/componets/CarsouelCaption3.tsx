...
//this is to have a face in animation
function CarsouselCarouselCaption3() {
  const ref = useRef();
  ...
  return (
    <Carousel.Caption ref={inViewRef} className={currentClassName}>
...
export default CarsouselCarouselCaption3;
